//
//  ProcModBassClipper.hpp
//  MacSmoov
//
//  Created by Paul Zaremba on 9/04/24.
//

#ifndef ProcModBassClipper_hpp
#define ProcModBassClipper_hpp
...
class ProcModBassClipper : public ProcessorModule {
public:
    ProcModBassClipper(const string& name, uint32_t _f_samp, uint8_t _n_channels, uint32_t _n_samps);
    virtual ~ProcModBassClipper();
